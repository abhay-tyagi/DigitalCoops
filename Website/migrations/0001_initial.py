# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2018-09-01 18:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pic', models.FileField(blank=True, null=True, upload_to=b'images/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.CharField(choices=[(b'Select course', b'-'), (b'Btech', b'Btech'), (b'Mtech', b'Mtect'), (b'MCA', b'MCA')], default=b'-', max_length=50)),
                ('category', models.CharField(choices=[(b'Select account', b'-'), (b'Admin', b'Admin'), (b'Student', b'Student')], max_length=50)),
            ],
        ),
        migrations.AddField(
            model_name='review',
